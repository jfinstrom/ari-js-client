...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Localhost8088.AsteriskPing();
  });
  ...
  describe('AsteriskPing', function() {
    it('should create an instance of AsteriskPing', function() {
      // uncomment below and update the code to test AsteriskPing
      //var instane = new Localhost8088.AsteriskPing();
      //expect(instance).to.be.a(Localhost8088.AsteriskPing);
    });
