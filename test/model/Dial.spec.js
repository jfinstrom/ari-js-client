...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Localhost8088.Dial();
  });
  ...
  describe('Dial', function() {
    it('should create an instance of Dial', function() {
      // uncomment below and update the code to test Dial
      //var instane = new Localhost8088.Dial();
      //expect(instance).to.be.a(Localhost8088.Dial);
    });
