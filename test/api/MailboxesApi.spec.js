...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Localhost8088.MailboxesApi();
  });
  ...
  describe('MailboxesApi', function() {
    ...
    describe('listmailboxes', function() {
      it('should call listmailboxes successfully', function(done) {
        //uncomment below and update the code to test listmailboxes
        //instance.listmailboxes(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
