...
* <pre>
* var AsteriskAri = require('index'); // See note below*.
* var xxxSvc = new AsteriskAri.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new AsteriskAri.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new AsteriskAri.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new AsteriskAri.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
